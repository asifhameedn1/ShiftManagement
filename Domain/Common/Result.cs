...
/// Use the non-generic <see cref="Result"/> for commands that return no value.
/// </summary>
public class Result
{
...
public sealed class Result<TValue> : Result
{
    ...
    /// <summary>
    /// Gets the value. Throws <see cref="InvalidOperationException"/> when the result is a failure.
    /// </summary>
    public TValue Value =>
        IsSuccess
            ? _value!
